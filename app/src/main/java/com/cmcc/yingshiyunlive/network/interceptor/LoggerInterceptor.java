package com.cmcc.yingshiyunlive.network.interceptor;

import android.text.TextUtils;

import com.cqmc.libdev.common.utils.ExceptionUtil;
import com.cqmc.libdev.common.utils.JsonUtil;
...
public class LoggerInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (!filterContentType(resContentType)) {
            // 打印请求的Cookie(Session)
            String cookie = oldResponse.header("request-cookie");
